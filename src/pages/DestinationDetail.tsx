...
import { getDestinationBySlug, Destination } from '../data/destinationsData';
...
const DestinationDetail = () => {
  ...
  const { isLoading: enquiryLoading, withLoading: withEnquiryLoading } = useLoading();
...
Looking forward to your expert guidance!`;
    ...
    const loadDestination = async () => {
      await withLoading(async () => {
        ...
        if (destinationSlug) {
          ...
          setDestination(dest);
          if (dest && dest.itineraries.length > 0) {
            setSelectedItinerary(dest.itineraries[0].id);
          }
        }
      });
    };
  ...
  const selectedItineraryData = destination.itineraries.find(it => it.id === selectedItinerary);
  ...
  return (
    <div className="min-h-screen bg-white pt-20">
      ...
      <section className="relative h-[70vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white max-w-4xl mx-auto px-4">
            ...
            <p className="text-xl md:text-2xl mb-2 animate-slide-up" style={{ animationDelay: '0.2s' }}>
              {destination.country}
            </p>
            <p className="text-lg md:text-xl mb-8 max-w-2xl mx-auto animate-slide-up" style={{ animationDelay: '0.4s' }}>
              {destination.description}
            </p>
            <div className="flex flex-wrap justify-center gap-4 animate-slide-up" style={{ animationDelay: '0.6s' }}>
              <div className="bg-white bg-opacity-20 backdrop-blur-sm rounded-lg px-4 py-2">
                <span className="text-sm font-medium">Best Time: {destination.bestTimeToVisit.months}</span>
              </div>
              <div className="bg-white bg-opacity-20 backdrop-blur-sm rounded-lg px-4 py-2">
                <span className="text-sm font-medium">From {destination.budgetRange.budget}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div id="tab-content-area" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {/* Overview Tab */}
        {activeTab === 'overview' && (
          <div className="space-y-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">Destination Highlights</h2>
                ...
                <div className="bg-gray-100 rounded-lg p-8 text-center">
                  ...
                  <p className="text-gray-600">Explore key attractions and points of interest</p>
              ...
              <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">{destination.bestTimeToVisit.months}</p>
                        <p className="text-sm text-gray-500">{destination.bestTimeToVisit.weather}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <p className="font-medium text-gray-900">Visa Requirements</p>
                        <p className="text-sm text-gray-600">{destination.visaRequirements.details}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">{destination.currency.name} ({destination.currency.code})</p>
                        <p className="text-sm text-gray-500">{destination.currency.exchangeRate}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">{destination.language.primary}</p>
                        {destination.language.others && (
                          <p className="text-sm text-gray-500">Also: {destination.language.others.join(', ')}</p>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">{destination.weather.climate}</p>
                        <p className="text-sm text-gray-500">Temp: {destination.bestTimeToVisit.temperature}</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-primary-50 rounded-lg p-6">
                  <h3 className="text-xl font-bold text-gray-900 mb-4">Budget Guide</h3>
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      <span className="text-gray-700">Budget</span>
                      <span className="font-semibold text-green-600">{destination.budgetRange.budget}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-700">Mid-range</span>
                      <span className="font-semibold text-blue-600">{destination.budgetRange.midRange}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-700">Luxury</span>
                      <span className="font-semibold text-purple-600">{destination.budgetRange.luxury}</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Choose from our carefully crafted itineraries or let us customize one just for you
              </p>
            </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
                <div className="bg-gradient-to-r from-primary-500 to-primary-700 text-white p-8">
                  <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
                    <div>
                      <h3 className="text-2xl font-bold mb-2">{selectedItineraryData.title}</h3>
                ...
                <div className="p-8">
                  ...
                  {/* Day by Day */}
                  <div>
                    <h4 className="text-lg font-semibold text-gray-900 mb-6">Day-by-Day Itinerary</h4>
                    <div className="space-y-6">
            ...
            <div className="bg-gray-50 rounded-2xl p-8">
              <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">Customization Options</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div>
                  <h4 className="font-semibold text-gray-900 mb-3">Accommodations</h4>
                  <ul className="space-y-2">
                    {destination.customizationOptions.accommodations.map((option, index) => (
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    {destination.customizationOptions.transportation.map((option, index) => (
                      <li key={index} className="text-sm text-gray-600 flex items-center space-x-2">
                        <Check className="w-3 h-3 text-green-500" />
                        <span>{option}</span>
                      </li>
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    {destination.customizationOptions.activities.map((option, index) => (
                      <li key={index} className="text-sm text-gray-600 flex items-center space-x-2">
                        <Check className="w-3 h-3 text-green-500" />
                        <span>{option}</span>
                      </li>
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    {destination.customizationOptions.specialRequirements.map((option, index) => (
                      <li key={index} className="text-sm text-gray-600 flex items-center space-x-2">
                        <Check className="w-3 h-3 text-green-500" />
                        <span>{option}</span>
                      </li>
        ...
        {activeTab === 'gallery' && (
          <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-lg text-gray-600">Explore the beauty of {destination.name}</p>
            </div>
        ...
        {activeTab === 'reviews' && (
          <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-lg text-gray-600">See what our customers say about {destination.name}</p>
            </div>
        ...
        {activeTab === 'enquiry' && (
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Plan Your Trip to {destination.name}</h2>
              ...
              <form onSubmit={handleEnquirySubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => setEnquiryForm(prev => ({ ...prev, travelers: parseInt(e.target.value) }))}
                      disabled={enquiryLoading}
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 disabled:bg-gray-100 disabled:cursor-not-allowed"
                      required
                    >
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => setEnquiryForm(prev => ({ ...prev, duration: e.target.value }))}
                      disabled={enquiryLoading}
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 disabled:bg-gray-100 disabled:cursor-not-allowed"
                      required
                    >
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                    {destination.customizationOptions.activities.map(activity => (
              ...
              {destination.gallery.map((_, index) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full transition-colors ${
                    index === selectedGalleryImage ? 'bg-white' : 'bg-white bg-opacity-50'
                  }`}
                />
              ))}
            </div>
