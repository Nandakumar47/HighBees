      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Discover the perfect travel experience tailored to your interests,
            preferences, and dreams
          </p>
        </div>

        {/* Trip Types Grid with improved mobile layout */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8">
          {tripTypes.map((tripType) => {
            ...
            return (
              ...
              >
                {/* Header with Image and Overlay - improved mobile layout */}
                <div className="relative h-48 sm:h-56 lg:h-64 overflow-hidden">
                  ...
                  />
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${tripType.color} opacity-75`}
                  />

                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center text-white px-2">
                      <div className="bg-white bg-opacity-20 backdrop-blur-sm rounded-full p-3 sm:p-4 mb-3 sm:mb-4 mx-auto w-12 h-12 sm:w-16 sm:h-16 flex items-center justify-center">
                ...
                <div className="p-4 sm:p-6 lg:p-8">
                  ...
                  <div className="mb-4 sm:mb-6">
                    ...
                    <div className="flex flex-wrap gap-1 sm:gap-2">
                      {tripType.destinations.map((destination, index) => (
                        <span
                          key={index}
                          className="px-2 sm:px-3 py-1 bg-gray-100 text-gray-700 text-xs sm:text-sm rounded-full hover:bg-primary-50 hover:text-primary-600 transition-colors cursor-pointer"
                        >
                          {destination}
                        </span>
                      ))}
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                    <button className="flex-1 bg-primary-500 hover:bg-primary-600 text-white font-semibold py-2 sm:py-3 rounded-lg transition-colors text-sm sm:text-base">
                      View Packages
                    </button>
                    <button className="px-4 sm:px-6 border-2 border-primary-500 text-primary-500 hover:bg-primary-500 hover:text-white font-semibold py-2 sm:py-3 rounded-lg transition-all duration-200 text-sm sm:text-base">
                      Learn More
                    </button>
                  </div>
                </div>
        ...
        {/* Bottom CTA Section with improved mobile layout */}
        <div className="mt-12 sm:mt-16 bg-gradient-to-r from-primary-500 to-primary-700 rounded-2xl p-6 sm:p-8 lg:p-12 text-center text-white">
          ...
          <p className="text-sm sm:text-base lg:text-lg mb-6 sm:mb-8 opacity-90 max-w-2xl mx-auto">
            ...
            specifically to your interests, budget, and timeline.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
            ...
            <button className="border-2 border-white text-white hover:bg-white hover:text-primary-500 font-semibold px-6 sm:px-8 py-2 sm:py-3 rounded-lg transition-all duration-200 text-sm sm:text-base">
              Speak with Expert
            </button>
          </div>
        </div>

        {/* Travel Tips with improved mobile layout */}
        <div className="mt-12 sm:mt-16 bg-white rounded-2xl shadow-lg p-4 sm:p-6 lg:p-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            <div className="text-center">
              <div className="bg-primary-100 rounded-full w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center mx-auto mb-3 sm:mb-4">
                <Heart className="w-5 h-5 sm:w-6 sm:h-6 text-primary-500" />
              </div>
              <h4 className="font-semibold text-gray-900 mb-2 text-sm sm:text-base">
                Consider Your Interests
              </h4>
              <p className="text-gray-600 text-xs sm:text-sm">
                Think about what activities and experiences excite you most when
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-xs sm:text-sm">
                Consider who you're traveling with - solo, couple, family, or
                friends - to choose the best fit.
              </p>
            </div>
            <div className="text-center sm:col-span-2 lg:col-span-1">
              ...
              <p className="text-gray-600 text-xs sm:text-sm">
                Match your available time and budget to find the perfect trip
                type for your needs.
              </p>
            </div>
          </div>
