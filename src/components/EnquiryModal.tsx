...
import { X, Mail, Phone, MapPin, Calendar, Users, DollarSign, Clock, MessageSquare, Save } from 'lucide-react';
...
const EnquiryModal: React.FC<EnquiryModalProps> = ({ enquiry, isOpen, onClose, onStatusUpdate }) => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-5xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-8">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-900">{enquiry.adults} Adults, {enquiry.children} Children</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="bg-primary-100 rounded-lg p-2">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-900">{enquiry.submittedAt}</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-900">{enquiry.destination}</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="bg-primary-100 rounded-lg p-2">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-900">{enquiry.departureCity}</p>
                  </div>
                </div>
              </div>
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-900">{enquiry.departureDate}</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="bg-primary-100 rounded-lg p-2">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-900">{enquiry.duration}</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="mt-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-900">{enquiry.budget}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {enquiry.communicationHistory && enquiry.communicationHistory.length > 0 && (
            <div>
